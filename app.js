...
app.get('/api/health',(req,res)=>res.json({status:'ok',service:'voxel-veda-app',timestamp:new Date().toISOString()}));
...
const protectedModuleRoutes=['/rfqs','/invoices','/customers','/suppliers','/stock','/raw-material','/packaging','/expenses','/workforce','/timesheets','/roster','/staff','/finance','/financial-years','/compliance','/forms','/settings','/meetings','/tasks'];
