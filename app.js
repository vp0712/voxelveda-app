...
app.get('/',sendPage('index.html'));app.get('/login',noIndex,sendPage('login.html'));app.get('/register',noIndex,sendPage('register.html'));app.get('/request-quote',sendPage('customer.html'));app.get('/privacy',sendPage('privacy-policy.html'));app.get('/terms',sendPage('terms.html'));app.get('/support',sendPage('support.html'));app.get('/careers',sendPage('careers.html'));app.get('/careers-admin',noIndex,pageAuth(),sendPage('careers-admin.html'));app.get('/forgot-password',noIndex,sendPage('forgot-password.html'));app.get('/reset-password',noIndex,sendPage('reset-password.html'));app.get('/accept-invite',noIndex,sendPage('accept-invite.html'));app.get('/mfa',noIndex,sendPage('mfa.html'));app.get('/security',noIndex,pageAuth({allowMfaSetup:true}),sendPage('security.html'));app.get('/attendance-terminal',noIndex,sendPage('shift-qr.html'));app.get('/401',noIndex,sendPage('401.html',401));app.get('/403',noIndex,sendPage('403.html',403));app.get('/404',noIndex,sendPage('404.html',404));app.get('/429',noIndex,sendPage('429.html',429));app.get('/500',noIndex,sendPage('500.html',500));app.get('/maintenance',noIndex,sendPage('maintenance.html',503));
app.get('/admin',noIndex,pageAuth({workspaceOnly:true}),renderAdminPage);app.get('/finance-intelligence',noIndex,pageAuth({workspaceOnly:true}),sendPage('finance-intelligence.html'));app.get('/banking',noIndex,pageAuth(),sendPage('finance-intelligence.html'));app.get('/dashboard',noIndex,pageAuth(),sendPage('staff-dashboard.html'));app.get('/profile',noIndex,pageAuth(),sendPage('profile.html'));app.get('/quality',noIndex,pageAuth({workspaceOnly:true}),sendPage('quality.html'));app.get('/shop-floor',noIndex,pageAuth(),sendPage('shop-floor.html'));app.get('/invoice/view',noIndex,pageAuth(),sendPage('invoice-pdf.html'));
