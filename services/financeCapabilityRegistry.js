const STATIC_CAPABILITIES = Object.freeze({
  ...
  user_preferences: { status: 'PARTIAL', source: 'finance_user_preferences', note: 'Per-user workspace/account/period/format/dashboard preferences are isolated by user and do not alter financial data; production workflow verification is still required before READY.' },
