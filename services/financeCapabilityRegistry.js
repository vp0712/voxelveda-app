const STATIC_CAPABILITIES = Object.freeze({
  ...
  forecast_planning: { status: 'PARTIAL', source: 'Personal Money Smart/Health/Roadmaps', note: 'Forecast, safe-to-spend and roadmap intelligence are exposed from existing evidence-backed engines; they are planning estimates and never mutate the ledger.' },
