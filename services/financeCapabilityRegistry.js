const STATIC_CAPABILITIES = Object.freeze({
  ...
  forecast_planning: { status: 'PARTIAL', source: 'Personal Money Smart/Health/Roadmaps + Banking OS', note: 'Forecast, safe-to-spend, roadmap intelligence and scheduled cash-flow events are evidence-based and never mutate the ledger; production workflow verification is still required.' },
  ...
  user_preferences: { status: 'PARTIAL', source: 'finance_user_preferences', note: 'Per-user workspace/account/period/formatting/dashboard preferences are isolated by user; reporting-currency preference never relabels native amounts without verified FX evidence.' },
