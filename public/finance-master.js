...
function personalView(){
 ...
 return resourceError('personal','My Money')+'<div class="fm-control-quick fm-personal-actions"><button data-personal-new="wallet">+ Personal wallet</button><button data-personal-new="cash">+ Cash movement</button><button data-personal-new="debt">Borrow / lend</button><button data-personal-new="savings">Savings goal</button></div><div class="fm-grid four">'+(cards+debtCards||'<div class="fm-kpi"><span>Personal Money</span><strong>—</strong><small>No owner-only wallets yet</small></div>')+'</div>'+dailyBriefingCard()+'<div class="fm-grid two">'+personalCard('budgets')+personalCard('debt')+'</div>';
}
