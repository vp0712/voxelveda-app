...
function reportDefinitionFromUi(){
 ...
 return {
  ...
  currency:fd.get('currency')||'',transaction_type:fd.get('transaction_type')||'',category:String(fd.get('category')||'').trim(),
