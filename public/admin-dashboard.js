Warning: truncated output (original token count: 102738)
    ...
    `
      <div class="stock-dialog-grid">
        <div class="dialog-card">
          ...
          <div id="manualCustom…52738 tokens truncated…atMoney(row.total_amount || 0)}</strong></td><td>${formatMoney(row.paid_amount || 0)}</td><td><strong>${formatMoney(row.balance || 0)}</strong></td>
