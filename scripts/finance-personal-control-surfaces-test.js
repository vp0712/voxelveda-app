...
for(const marker of [
  'SUBSCRIPTION & RECURRING COMMITMENT CONTROL','SAVINGS & RESERVE CONTROL','PERSONAL TAX & EVIDENCE CONTROL',
...
assert(master.includes('data-savings-control'),'Savings control metadata action missing.');
assert(master.includes('data-savings-statement'),'Savings statement action missing.');
...
assert(master.includes('never move money'),'Savings workspace must state its no-money-movement boundary.');
