...
const files = [
  ...
  'public/service-worker.js', 'scripts/finance-accountant-handover-test.js', 'scripts/finance-advanced-control-test.js', 'scripts/finance-cash-control-test.js', 'scripts/finance-close-assurance-test.js', 'scripts/personal-debt-control-test.js', 'scripts/finance-master-os-test.js', 'scripts/finance-legacy-ui-gate-test.js', 'scripts/enterprise-wave-a-test.js', 'scripts/wave-b-pr1-platform-guards-test.js', 'scripts/wave-b-pr2-worker-safety-test.js', 'scripts/wave-b-pr3-qms-fail-closed-test.js', 'scripts/generate-enterprise-inventory.js', 'scripts/update-enterprise-audit-baseline.js', 'scripts/check-enterprise-audit-provenance.js'
];
