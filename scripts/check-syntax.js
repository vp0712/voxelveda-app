...
const files = [
  ...
  'controllers/financeController.js', 'controllers/financeOperationsController.js', 'controllers/taskController.js', 'controllers/userController.js',
  'middleware/auth.js', 'middleware/pageAuth.js', 'middleware/securityMiddleware.js', 'middleware/authorizationMiddleware.js', 'middleware/permissionMiddleware.js', 'middleware/inputPermissionMiddleware.js',
  'routes/attendanceRoutes.js', 'routes/authRoutes.js', 'routes/emailRoutes.js', 'routes/uploadRoutes.js',
  'routes/financeRoutes.js', 'routes/expenseRoutes.js', 'routes/invoiceRoutes.js', 'routes/taskRoutes.js', 'routes/userRoutes.js', 'routes/meetingRoutes.js', 'routes/rosterRoutes.js',
  ...
  'services/securitySchema.js', 'services/sessionService.js', 'services/authSessionService.js', 'services/authActionTokenService.js', 'services/mfaService.js', 'services/authorizationService.js',
