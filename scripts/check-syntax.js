...
const files = [
  ...
  'controllers/notificationController.js', 'controllers/trashController.js', 'controllers/workflowController.js', 'controllers/procurementController.js', 'controllers/backgroundJobController.js',
  'controllers/financeController.js', 'controllers/financeOperationsController.js', 'controllers/financeCounterpartyController.js', 'controllers/financeJobProfitabilityController.js', 'controllers/financeTreasuryController.js', 'controllers/financePerformanceRiskController.js', 'controllers/financeAnomalyExplainController.js', 'controllers/financePlanningControlController.js', 'controllers/financeCashControlController.js', 'controllers/financeCashCustodyController.js', 'controllers/financeCloseAssuranceController.js', 'controllers/financeAccountantHandoverController.js', 'controllers/personalDebtPlanningController.js', 'controllers/personalRecurringCommitmentController.js', 'controllers/personalSavingsReserveController.js', 'controllers/personalTaxEvidenceControlController.js', 'controllers/highRiskFinanceController.js', 'controllers/taskController.js', 'controllers/userController.js', 'controllers/stepUpController.js', 'controllers/securityDashboardController.js', 'controllers/securityGovernanceController.js', 'controllers/securityTelemetryController.js', 'controllers/operationalTrustController.js', 'controllers/continuousAssuranceController.js', 'controllers/integrationWebhookController.js',
  ...
  'services/financeDomain.js', 'services/financeCashCustodyService.js', 'services/financeSchema.js', 'services/financeCloseAssuranceService.js', 'services/financeEncryptionService.js', 'services/highRiskFinanceSchema.js', 'services/passwordPolicy.js',
  ...
  'public/service-worker.js', 'scripts/finance-release-consistency-test.js', 'scripts/finance-job-profitability-test.js', 'scripts/finance-full-surface-acceptance-test.js', 'scripts/finance-production-regression-suite.js', 'scripts/finance-fpa-planning-control-test.js', 'scripts/finance-performance-risk-control-test.js', 'scripts/finance-anomaly-explain-control-test.js', 'scripts/finance-governance-controls-test.js', 'scripts/finance-accountant-handover-test.js', 'scripts/finance-advanced-control-test.js', 'scripts/finance-counterparty-control-test.js', 'scripts/finance-cash-control-test.js', 'scripts/finance-cash-custody-control-test.js', 'scripts/finance-close-assurance-test.js', 'scripts/finance-treasury-control-test.js', 'scripts/personal-debt-control-test.js', 'scripts/personal-recurring-commitment-control-test.js', 'scripts/personal-savings-reserve-control-test.js', 'scripts/personal-tax-evidence-control-test.js', 'scripts/finance-master-os-test.js', 'scripts/finance-legacy-ui-gate-test.js', 'scripts/enterprise-wave-a-test.js', 'scripts/wave-b-pr1-platform-guards-test.js', 'scripts/wave-b-pr2-worker-safety-test.js', 'scripts/wave-b-pr3-qms-fail-closed-test.js', 'scripts/generate-enterprise-inventory.js', 'scripts/update-enterprise-audit-baseline.js', 'scripts/check-enterprise-audit-provenance.js'
];
