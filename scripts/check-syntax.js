...
const files = [
  ...
  'controllers/financeController.js', 'controllers/financeOperationsController.js', 'controllers/highRiskFinanceController.js', 'controllers/taskController.js', 'controllers/userController.js', 'controllers/stepUpController.js', 'controllers/securityDashboardController.js', 'controllers/operationalTrustController.js', 'controllers/integrationWebhookController.js',
  'middleware/auth.js', 'middleware/pageAuth.js', 'middleware/securityMiddleware.js', 'middleware/authorizationMiddleware.js', 'middleware/permissionMiddleware.js', 'middleware/inputPermissionMiddleware.js', 'middleware/stepUpMiddleware.js', 'middleware/highRiskPaymentMiddleware.js', 'middleware/sensitiveExportMiddleware.js',
  ...
  'services/securityEmailService.js', 'services/operationalTrustSchema.js', 'services/apiTokenService.js', 'services/webhookSecurityService.js', 'services/outboundRequestPolicy.js', 'services/aiSecurityPolicy.js', 'services/securityAlertService.js', 'config/security.js', 'config/permissionCatalog.js',
