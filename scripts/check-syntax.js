...
const files = [
  ...
  'services/databaseRuntimeService.js', 'services/migrationRunner.js', 'services/runtimeState.js',
  ...
  'public/service-worker.js', 'scripts/enterprise-wave-a-test.js', 'scripts/generate-enterprise-inventory.js'
];
