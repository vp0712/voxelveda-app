...
assert(risk.includes('/personal-tax-financial-year-intelligence.js?v=20260916-tax-financial-year'),'Risk Intelligence must load Personal Tax & Financial-Year Intelligence.');
...
require('./personal-tax-financial-year-intelligence-test');
console.log('Personal Financial Risk, Protection, Insurance and Tax Intelligence regression checks passed.');
