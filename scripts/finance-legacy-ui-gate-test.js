...
for(const asset of ['finance-intelligence.html','finance-master.js','finance-master.css','finance-bootstrap-guard.js','finance-advanced-control.js','finance-margin-allocation.js']){
...
assert(app.includes("'finance-margin-allocation.js'"),'canonical Margin Allocation asset missing from allowlist.');
