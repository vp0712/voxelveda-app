...
assert.match(html,/finance-master\.js\?v=20260924-profitability-v1/,'Master finance client must be loaded with the current cache-busting release id.');
...
assert.match(js,/\['profitability','◩','Profitability & Margin'\]/,'Profitability & Margin must be a first-class canonical Finance planning module.');
assert.match(js,/function profitabilityControlView\(\)/,'Profitability & Margin canonical view loader is missing.');
assert.match(js,/finance-profitability-control\.js\?v=20260924-profitability-v1/,'Profitability & Margin asset version must be pinned.');
