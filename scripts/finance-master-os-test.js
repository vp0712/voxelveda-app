...
assert.match(html,/finance-master\.js\?v=20260924-control-v12/,'Master finance client must be loaded with the current cache-busting release id.');
...
assert.match(js,/finance-advanced-control\.js\?v=20260924-advanced-control-v12/,'Advanced Finance Control must use the canonical versioned asset.');
