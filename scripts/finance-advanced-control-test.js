...
assert(advanced.includes("VERSION='20260924-advanced-control-v6'"),'Advanced Finance release id is missing.');
...
assert(master.includes('/finance-advanced-control.js?v=20260924-advanced-control-v6'),'Master OS must load the versioned Advanced Control asset.');
assert(app.includes("'finance-advanced-control.js'"),'Advanced Control must be allowlisted as a canonical Finance asset.');
assert(html.includes('/finance-master.js?v=20260924-governance-control-v1'),'Canonical Finance HTML must cache-bust the current canonical Finance release.');
...
for(const label of [
  ...
  'Tax, Evidence & Year-End Readiness','Company CFO Control','Accountant Handover Readiness','Automation & Approval Control','Decision Intelligence — Plan A vs Plan B','Performance & Stress Control','Evidence Source Health'
...
for(const endpoint of [
  ...
  '/api/finance/receipts','/api/finance/reimbursements','/api/finance/accountant-handover','/api/finance/personal-money/review-inbox','/api/finance/intelligence/banking-readiness','/api/notifications','/api/finance/intelligence/rules','/api/finance/close-assurance','/api/finance/performance-risk-control'
