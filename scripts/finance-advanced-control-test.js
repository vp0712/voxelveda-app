...
for(const label of [
  ...
  'Tax, Evidence & Year-End Readiness','Company CFO Control','Accountant Handover Readiness','Automation & Approval Control','Decision Intelligence — Plan A vs Plan B','Evidence Source Health'
...
for(const endpoint of [
  ...
  '/api/finance/receipts','/api/finance/reimbursements','/api/finance/accountant-handover','/api/finance/personal-money/review-inbox','/api/finance/intelligence/banking-readiness','/api/notifications','/api/finance/intelligence/rules','/api/finance/close-assurance'
