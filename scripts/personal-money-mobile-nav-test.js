...
assert(ui.includes("const MOBILE_NAV=[['advanced','⚡','Control'],['accounts','▣','Accounts'],['transactions','↕','Transactions'],['statements','▤','Statements'],['more','☰','More']]"),'Unified mobile bottom navigation must keep Advanced Control as the canonical home.');
