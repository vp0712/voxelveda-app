...
assert(master.includes('handoverNewQuery'),'Handover must allow creating accountant questions in-place.');
assert(master.includes('data-handover-answer'),'Handover must allow answering accountant questions in-place.');
assert(master.includes('data-handover-resolve'),'Handover must allow resolving accountant questions in-place.');