...
const financeCashCustody = require('../controllers/financeCashCustodyController');
...
router.get('/cash-control/custody', requireAnyPermission('VIEW_BANKING'), financeCashCustody.getCenter);
router.post('/cash-control/custody', requireAnyPermission('EDIT_FINANCE'), requireStepUp('ISSUE_CASH_CUSTODY'), financeCashCustody.issue);
router.post('/cash-control/custody/:uid/return', requireAnyPermission('EDIT_FINANCE'), financeCashCustody.recordReturn);
router.get('/cash-control/custody/:uid/expense-candidates', requireAnyPermission('VIEW_BANKING'), financeCashCustody.expenseCandidates);
router.post('/cash-control/custody/:uid/clear-expense', requireAnyPermission('EDIT_FINANCE'), requireStepUp('CLEAR_CASH_CUSTODY'), financeCashCustody.clearExpense);
router.post('/cash-control/custody/:uid/cancel', requireAnyPermission('EDIT_FINANCE'), requireStepUp('CANCEL_CASH_CUSTODY'), financeCashCustody.cancel);
router.post('/cash-control/custody/events/:eventUid/reverse', requireAnyPermission('EDIT_FINANCE'), requireStepUp('REVERSE_CASH_CUSTODY_EVENT'), financeCashCustody.reverseEvent);
